...
/// <summary>
/// Интерфейс клиента для будущего телеграм-бота. Здесь описан интерфейс, который должен реализовывать 
/// любой клиент для взаимодействия с нашим фейковым Telegram'ом.
/// </summary>
public interface ITelegramBotClient
{
    /// <summary>
    /// Метод начала взаимодействия клиента с телеграм-ботом. Запускает обработку обновлений.
    /// </summary>
